...
const Navbar = () => {
  ...
  return (
    <nav className="fixed bg-transparent backdrop-blur-sm py-5 w-full top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div
          className={cn(
            "md:hidden fixed left-0 right-0 bg-white/80 backdrop-blur-lg transition-all duration-300 ease-in-out z-50",
